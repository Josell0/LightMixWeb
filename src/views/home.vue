        ...
        <div class="cButtons">
            ...
            <div class="cMainButtons">
                ...
                <div class="cBoxDownloadButton">
                    <button class="cDownloadButton" @click="homeStore.imageDownload()">Download Image</button>
            ...
            <div class="cPerfilButtons">
                <div class="cBoxPerfilCreated" v-for="(item, index) in homeStore.profileButtons.valoresSecondaryOpacity"
                    key="index">
                    <button class="cButtonDeleteProfile"
                        :class="[homeStore.profileButtons.valoresSecondaryOpacity[index][0] ? 'cDisplayOn' : 'cDisplayOff']"
